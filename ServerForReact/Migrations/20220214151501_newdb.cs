        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PathImg = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JoinCourse = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentsSubscriptionId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduleHangfireJobs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScheduleHangfireJobs_StudentCourses_StudentsSubscriptionId",
                        column: x => x.StudentsSubscriptionId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleHangfireJobs_StudentsSubscriptionId",
                table: "ScheduleHangfireJobs",
                column: "StudentsSubscriptionId");
